...
这是支持真人、多种剧作家 AI，以及 FS/BTX 可选团队 ISMCTS 主人公 AI 的热座/局域网裁判工具，不含公网大厅。双方策略的现状与限制见 [AI 阶段性总结](docs/ai-current-state.md)。
...
1 名主人公玩家的两人局中还可选择“团队 ISMCTS”“当日生存优先 ISMCTS”及旧版对照（均限 FS/BTX 完整搜索）。剧作家席位可选择定式 AI、朴素 MCTS、优化 MCTS 或策略 MCTS。基础干扰 AI 会在下一天尝试
逆转剧作家的成功移动，并约定仅逻辑领队使用禁止密谋；防守版还会根据公开事件、身份、计数物和结构化好感能力选择行动；
历史风险版会按时间衰减统计公开揭牌中的剧作家关注目标。主人公 AI 均不读取真实剧本秘密。定式 AI 会从规则失败、

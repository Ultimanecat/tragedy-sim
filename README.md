...
选择规则集、昵称和座位后创建房间，再把页面中的邀请链接发给另外三名玩家。每人选择一个空座并准备；
四人全部准备后由房主开始。页面每秒检查一次 revision，仅在房间或游戏状态变化时更新；刷新页面会恢复本机席位。
...
剧作家、三位主人公和旁观者看到的内容由后端分别过滤。房主可以在等待大厅释放误占座位、关闭房间，并在游戏中保存或导出回放。

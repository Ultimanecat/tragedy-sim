...
主人公玩家；房主可用随机 AI 填充任意空位，主人公席位可选择“基础干扰”“公开信息防守”或实验性的“历史风险”AI，剧作家席位可选择定式 AI、朴素 MCTS、优化 MCTS 或策略 MCTS。基础干扰 AI 会在下一天尝试逆转剧作家的成功移动，并约定仅逻辑领队使用禁止密谋；防守版还会根据公开事件、身份、计数物和结构化好感能力选择行动；历史风险版会按时间衰减统计公开揭牌中的剧作家关注目标。三者均不读取剧本秘密。定式 AI 会从规则失败、

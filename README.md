...
这是由真人控制双方的热座/局域网裁判工具，不含 AI 或公网大厅。
...
行动牌可以拖向服务端给出的合法目标，也始终可以使用“点击牌、点击目标、确认执行”的操作方式。
...
选择规则集、主人公玩家人数、昵称和座位后创建房间，再分享页面中的邀请链接。支持 1 名剧作家加 1–3 名
主人公玩家；所需玩家全部入座并准备后由房主开始。页面每秒检查一次 revision，仅在房间或游戏状态变化时更新；
刷新页面会恢复本机席位。
